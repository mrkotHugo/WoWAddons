local L = LibStub("AceLocale-3.0"):NewLocale("LibObjectInfo", "enUS", true, false)
...
L["Osmenite Deposit"] = true
L["Rich Osmenite Deposit"] = true
L["Osmenite Seam"] = true

-- ** Shadowlands **
L["Laestrite Deposit"] = true
L["Rich Laestrite Deposit"] = true
L["Solenium Deposit"] = true
L["Rich Solenium Deposit"] = true
L["Oxxein Deposit"] = true
L["Rich Oxxein Deposit"] = true
L["Phaedrum Deposit"] = true
L["Rich Phaedrum Deposit"] = true
L["Sinvyr Deposit"] = true
L["Rich Sinvyr Deposit"] = true
L["Elethium Deposit"] = true
L["Rich Elethium Deposit"] = true
L["Ligneous Phaedrum Deposit"] = true
L["Monolithic Oxxein Deposit"] = true
L["Menacing Sinvyr Deposit"] = true
L["Luminous Solenium Deposit"] = true
...
-- ** Battle for Azeroth **
L["Akunda's Bite"] = true
L["Anchor Weed"] = true
L["Riverbud"] = true
L["Sea Stalks"] = true
L["Siren's Sting"] = true
L["Star Moss"] = true
L["Winter's Kiss"] = true
L["Zin'anthid"] = true

-- ** Shadowlands **
L["Death Blossom"] = true
L["Marrowroot"] = true
L["Nightshade"] = true
L["Rising Glory"] = true
L["Vigil's Torch"] = true
L["Widowbloom"] = true